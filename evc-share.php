...
function evc_widget_settings_admin_init() {
	...
	$fields = array(
        ...
        <br/>Какие права запрашивать у пользователя при авторизации через ВКонтакте. По умолчанию запрашивается только доступ к общей информации.', 'evc' ),
			...
			array(
				'name'    => 'evc_vk_link_button',
				'label'   => __( 'Кнопка Привязать аккаунт VK', 'evc' ),
				'desc'    => __( 'Показывать или нет кнопку "Привязать аккаунт ВКонтакте" в админ панели на странице <a href = "' . admin_url( 'profile.php' ) . '">редактирования данных пользователя</a>.', 'evc' ),
				'type'    => 'radio',
				'default' => '1',
				'options' => array(
					'1' => 'Показывать',
