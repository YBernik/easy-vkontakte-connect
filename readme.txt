...
= 2.5.1 / 2018-05-29 =
* Добавлена возможность отключить отображение кнопки Привязать аккаунт ВК в админ панели. / 2018-06-04 / 2.5.001
* Поддержка авторизации через ВК на multisite. / 2.5.002 / 2018-06-06
